...
Environment used : Anaconda 3.0 and Python 3.8.5 IDLE
'''
#<Code info>
"""
...
print()
print("Calculate Income Tax and Display Report - 1 ")
print()
print("View Tax Slabs - 2 ")
print()
print("Display Already Calculated Income Taxes - 3 ")
print()
print("See what Tax Slab you Come under - 4")
print()
...
if f==1:
    ...
    taxpayer.at[0]=[PAN,aadhar,name,mobileno,income,rate*100,tax] #If using spyder use int(tax)
    print()
